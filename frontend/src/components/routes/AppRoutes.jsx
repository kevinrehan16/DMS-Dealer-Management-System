...
import StockUnits from "../../pages/Inventory/StockUnits";
import UnitCatalog from "../../pages/Inventory/UnitCatalog";
        ...
        <AuthProvider>
          <Routes>
            ...
            >
              ...
              <Route path="/inventory/unit-catalog" element={<UnitCatalog />} />
